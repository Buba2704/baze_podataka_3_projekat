...
public class FormUnosStavkeZOPM extends javax.swing.JDialog {
    
    private Proizvod p;

    public FormUnosStavkeZOPM(JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnUnesiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUnesiActionPerformed
        try {
            ...
            FormListaStavkiZOPM ls = (FormListaStavkiZOPM) getParent();
            ls.refreshTable();
            JOptionPane.showMessageDialog(this, "Uspesno uneta stavka.");
            this.dispose();
        } catch (Exception ex) {
            //Logger.getLogger(FormUnosStavkeZOPM.class.getName()).log(Level.SEVERE, null, ex);
