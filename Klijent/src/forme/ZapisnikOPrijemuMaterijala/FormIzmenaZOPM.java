...
public class FormIzmenaZOPM extends javax.swing.JDialog {
    
    private StavkaZapisnikaOPrijemuMaterijala s;
    private Proizvod p;
    FormListaZOPM fs = (FormListaZOPM) getParent();


    public FormIzmenaZOPM(JDialog parent, boolean modal, StavkaZapisnikaOPrijemuMaterijala s) {
        super(parent, modal);
        initComponents();
    ...
    private void popuniProizvode() {
         try {
            ...
            Logger.getLogger(FormIzmenaZOPM.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
