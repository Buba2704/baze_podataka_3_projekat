 ...
 * @author zoran
 */
public class ZapisnikGRP2 extends AbstractDomainObject {
    ...
    public ZapisnikGRP2(Long sifZGR, Long evidencioniBroj, Date datumDokumenta, String oznaka, OrganizacionaJedinica orgJed, Radnik radnik, Magacin magacin) {
        this.sifZGR = sifZGR;
    ...
    public ArrayList<AbstractDomainObject> vratiListu(ResultSet rs) throws SQLException {
        ...
        while(rs.next()){
            Radnik r = new Radnik(rs.getLong("sifRadnika"), rs.getString("ime"), rs.getString("prezime"), 0l, null, rs.getLong("telefon"), rs.getString("adresa"));
             ...
             ZapisnikGRP2 z = new ZapisnikGRP2(rs.getLong("sifZGR"), rs.getLong("evidencioniBroj"), rs.getDate("datumDokumenta"), rs.getString("oznaka"), org, r, m);
            lista.add(z);
        }
        rs.close();
        return lista;
    ...
    public String vrednostiZaInsert() {
          return " " + sifZGR + ", " + evidencioniBroj + ", "
            + " '" + datumDokumenta + "', '" + oznaka + "', " +orgJed.getSifOrgJed() + ", " + radnik.getSifRadnika() + ", " + magacin.getSifMagacina() + " ";
    }

    @Override
    public String vrednostiZaUpdate() {
        return " evidencioniBroj = " + evidencioniBroj + ", datumDokumenta = '" + datumDokumenta + "', oznaka = '" + oznaka + "', sifOrgJed = " + orgJed.getSifOrgJed() + ", sifRadnika = " + radnik.getSifRadnika() + ", sifMagacina = " + magacin.getSifMagacina() + " ";
    }

    @Override
    public String uslov() {
       return "partition(P2_PRETHODNAGOD_DOK)";
    }
