 ...
 * @author zoran
 */
public class ZapisnikGRP1 extends AbstractDomainObject {
    ...
    public ZapisnikGRP1(Long sifZGR, Long evidencioniBroj, Date datumDokumenta, String oznaka, OrganizacionaJedinica orgJed, Radnik radnik, Magacin magacin) {
        this.sifZGR = sifZGR;
    ...
    public ArrayList<AbstractDomainObject> vratiListu(ResultSet rs) throws SQLException {
        ...
        while(rs.next()){
            Radnik r = new Radnik(rs.getLong("sifRadnika"), rs.getString("ime"), rs.getString("prezime"), 0l, null, rs.getLong("telefon"), rs.getString("adresa"));
             ...
             ZapisnikGRP1 z = new ZapisnikGRP1(rs.getLong("sifZGR"), rs.getLong("evidencioniBroj"), rs.getDate("datumDokumenta"), rs.getString("oznaka"), org, r, m);
            lista.add(z);
        }
        rs.close();
        return lista;
    ...
    @Override
    public String uslov() {
       return "partition(P1_STARIJA_DOK)";
    }
